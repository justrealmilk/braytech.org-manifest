...
import BraytechMaspTypesDefinition from '@Data/manifest/zh-CHS/BraytechMapsTypesDefinition.json';
...
import DestinyDestinationDefinition from '@Data/manifest/zh-CHS/DestinyDestinationDefinition.json';
