import BraytechActivityDefinition from './BraytechActivityDefinition.json';
import BraytechActivityDifficultyDefinition from './BraytechActivityDifficultyDefinition.json';
...
import DestinyClanBannerDefinition from './DestinyClanBannerDefinition.json';
...
import DestinyPresentationNodeDefinition from './DestinyPresentationNodeDefinition.json';
import DestinyRecordDefinition from './DestinyRecordDefinition.json';
import DestinySeasonDefinition from './DestinySeasonDefinition.json';
import DestinySocketCategoryDefinition from './DestinySocketCategoryDefinition.json';
import DestinySocketTypeDefinition from './DestinySocketTypeDefinition.json';
import DestinySourceDefinition from './DestinySourceDefinition.json';
import DestinyStatDefinition from './DestinyStatDefinition.json';
import DestinyTraitDefinition from './DestinyTraitDefinition.json';

import DestinyCollectibleDefinitionColloquial from './DestinyCollectibleDefinitionColloquial.json';
import DestinyInventoryItemDefinitionColloquial from './DestinyInventoryItemDefinitionColloquial.json';
